// Human gate state model — A-Branch Architectural Principle 6: "Human
// approval is a real state transition, enforced in code, not documentation."
// docs/architecture/01_PIPELINE_1_ARCHITECTURE.md "Human Gates" section
// defines Gate A1 as exactly two such transitions.
//
